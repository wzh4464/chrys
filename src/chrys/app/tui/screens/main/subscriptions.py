    ...
    def __init__(
        ...
        *,
        ...
        self._subscriptions: tuple[EventSubscription[Any], ...] = (
            ...
            _sub(RequirementClarificationPhaseChanged, events.on_requirement_clarification_phase),
            _sub(TurnRouted, events.on_turn_routed),
            _sub(LongHorizonPhaseChanged, events.on_long_horizon_phase),
