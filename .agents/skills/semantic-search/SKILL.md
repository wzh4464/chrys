...
5. **Analyze artifacts when needed**
   - Use `scripts/analyze_augmented_run.py` for an offline artifact summary.
   - Offline benchmark metadata analysis must stay separate from runtime augmentation.
